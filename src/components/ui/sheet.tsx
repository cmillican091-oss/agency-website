  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed z-50 flex flex-col gap-4 border border-white/10 bg-slate-950/95 p-6 text-slate-50 shadow-2xl backdrop-blur-xl transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
          side === "right" &&
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-4 right-4 rounded-md p-1 text-slate-400 transition hover:bg-white/8 hover:text-slate-100">
          <X className="size-4" />
